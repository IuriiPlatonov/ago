...
public class GetReportTileViewImpl extends DefaultTilePanel
        implements GetReportTileView
{
    ...
    public GetReportTileViewImpl()
    {
        super();
        setCaption(CONSTANTS.getReportName());
