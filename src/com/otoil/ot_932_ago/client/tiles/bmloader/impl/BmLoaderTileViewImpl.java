package com.otoil.ot_932_ago.client.tiles.bmloader.impl;
...
public class BmLoaderTileViewImpl extends DefaultTilePanel
        implements BmLoaderTileView
{
    private final OreMainConstants CONSTANTS = OreMainConstantsFactory.getInstance();

    @Getter
    private final  NSAcceptButton openButton = new NSAcceptButton(
        CONSTANTS.bmStartBtn());

    public BmLoaderTileViewImpl()
    {
        super();
        setCaption(CONSTANTS.bmLoaderTitle());
