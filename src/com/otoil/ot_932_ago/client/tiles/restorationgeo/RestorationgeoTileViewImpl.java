...
public class RestorationgeoTileViewImpl extends DefaultTilePanel
        implements RestorationgeoTileModelTileView
{
    ...
    public RestorationgeoTileViewImpl()
    {
        super();
        setCaption(resources.restorationGeology());
